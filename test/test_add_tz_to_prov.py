...
class test_add_tz_to_prov(unittest.TestCase):
    def test_add_tz_to_prov_csv(self):
        ...
        add_tz_to_prov(src, dst, 'csv', tz_offset=timedelta(hours=2))
        output_data = list()
        ...
        expected_data = [
            {'oci': '02001000106361937121617370200010737000637000403-02001000907362821103700110001031403010801101204131513', 'snapshot': '1', 'agent': 'https://w3id.org/oc/index/prov/pa/1', 'source': 'https://api.crossref.org/works/10.1016/j.cgh.2017.06.043', 'created': '2022-06-13T14:57:39+02:00', 'invalidated': '', 'description': 'Creation of the citation', 'update': ''}, 
            {'oci': '020010201053600030601060807086303090400040509-0200100010636280000030363030504095800045905000205026302', 'snapshot': '1', 'agent': 'https://w3id.org/oc/index/prov/pa/1', 'source': 'https://api.crossref.org/works/10.1215/03616878-3940459', 'created': '2022-06-13T14:57:39+02:00', 'invalidated': '', 'description': 'Creation of the citation', 'update': ''}, 
            {'oci': '020030106013600000003040504010433060802040603-02005090602361117213725102729370200050208', 'snapshot': '1', 'agent': 'https://w3id.org/oc/index/prov/pa/1', 'source': 'https://api.crossref.org/works/10.3161/000345414x682463', 'created': '2022-06-13T14:58:02+02:00', 'invalidated': '', 'description': 'Creation of the citation', 'update': ''}, 
            {'oci': '020010207020036191222370937063704070563040802-020010104053609040103010137090401030103', 'snapshot': '1', 'agent': 'https://w3id.org/oc/index/prov/pa/1', 'source': 'https://api.crossref.org/works/10.12720/jcm.9.6.475-482', 'created': '2022-06-13T14:58:02+02:00', 'invalidated': '', 'description': 'Creation of the citation', 'update': ''}]
        rmtree(dst)
    ...
    def test_add_tz_to_prov_nquads(self):
        ...
        dst = os.path.join('test', 'output')
        add_tz_to_prov(src, dst, 'nquads', tz_offset=timedelta(hours=2))
        output_data = set()
        ...
        expected_data = {
            ...
            'https://w3id.org/oc/index/coci/ci/020030106013600000003040504010433060802040603-02005090602361117213725102729370200050208/prov/se/1 http://www.w3.org/ns/prov#generatedAtTime 2022-06-13T14:58:02+02:00 https://w3id.org/oc/index/coci/ci/020030106013600000003040504010433060802040603-02005090602361117213725102729370200050208/prov/', 
            ...
            'https://w3id.org/oc/index/coci/ci/02001000106361937121617370200010737000637000403-02001000907362821103700110001031403010801101204131513/prov/se/1 http://www.w3.org/ns/prov#generatedAtTime 2022-06-13T14:57:39+02:00 https://w3id.org/oc/index/coci/ci/02001000106361937121617370200010737000637000403-02001000907362821103700110001031403010801101204131513/prov/'}
        rmtree(dst)
        self.assertEqual(output_data, expected_data)
